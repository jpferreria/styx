...
export class UnixKernel {
  ...
  private setupHierarchy() {
    ...
    const sampleWasmNode = userHome?.createChild("sample_app.wasm", false, 0o755);
    if (sampleWasmNode) {
      sampleWasmNode.write(0, createMessageWasmBinary("Hello from Custom Styx WASM App!\n"));
    }
